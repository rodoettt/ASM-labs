...
sizebuf = 18 ;сколько символов будем считывать за раз
...
handle1:	
    mov 	inhan, ax; присвоение идентификатора файла
...
continue:	
    mov 	buf, ax; адрес выделенного блока памяти
...
for1:       
	cmp 	byte ptr es:[si], 0C0h ; проверка, больше ли символ 'А'
	jb		co3  ; если меньше, пропускаем
	cmp 	byte ptr es:[si], 0DFh ; проверка, меньше ли символ 'Я'
	ja		co3  ; если больше, пропускаем
	add 	byte ptr es:[si], 20h ; преобразование в строчную букву
